# Contributing to can-define-lazy-value

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-define-lazy-value) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-define-lazy-value, you can start by going to its [fork page](https://github.com/canjs/can-define-lazy-value/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-define-lazy-value
```
